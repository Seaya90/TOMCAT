...
<%
	request.setAttribute("attr_name", request.getParameter("name") + "-attr");
	request.setAttribute("attr_age", request.getParameter("age") + "-attr");
%>	
	...
	자바빈(Bean)은 데이타를 저장 목적으로 JSP에서 제공되는 저장소
	<useBean 액션태그의 역할 및 사용법>
	1. VO객체 생성(자바 VO 클래스로 형식으로 작성된) 
	2. 자바빈 생성(useBean 액션 태그 <jsp:useBean></jsp:useBean> 사용)
		id : 사용할 변수명 
...
--%>	
	...
	<h2>이름 : <jsp:getProperty property="age" name="person"/></h2>
