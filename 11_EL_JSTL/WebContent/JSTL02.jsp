...
%>
	...
	<%-- 
		minIntegerDigits : 정수부의 최소표시 자리수 지정(없으면 0 표시)
		minFractionDigits : 소수부(소수점이하) 최소자리 지정(없으면 0 표시)
		maxIntegerDigits : 정수부 최대 표시 자리수 지정(넘치면 버려짐)
		maxFractionDigits : 소수점 이하 표시 자리수 지정
			(넘치면 버려짐, 단 숫자값 6부터 올림처리)
	--%>
	...
	<fmt:formatNumber value="123.4" type="number" minFractionDigits="2" maxFractionDigits="2"/><br>
	<hr>
	...
	<p>소수점 이하 4번째가 6인 경우 : 올림처리</p>
	<fmt:formatNumber value="123456.8886" pattern=".000"/><br>
	<fmt:formatNumber value="123456.8886" pattern=".###"/><br>
	
	<hr>
	<%-- 자리수 이하 값이 5 이상 부터 올림 처리 --%>
	<p>소수점 이하 4번째가 5인 경우 : 올림처리</p>
	123456.8885 - <fmt:formatNumber value="123456.8885" pattern=".000"/><br>
	123456.8885 - <fmt:formatNumber value="123456.8885" pattern=".###"/><br>
	
	<%-- 자리수 이하 값이 4이하인 경우 버림 처리 --%>
	<p>소수점 이하 4번째가 4인 경우 : 버림처리</p>
	123456.8884 - <fmt:formatNumber value="123456.8884" pattern=".000"/><br>
	123456.8884 - <fmt:formatNumber value="123456.8884" pattern=".###"/><br>
	<hr>
	...
	<fmt:formatDate type="both" value="${now }" timeStyle="short"/><br>
