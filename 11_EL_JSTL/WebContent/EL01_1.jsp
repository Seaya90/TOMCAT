...
<%-- 표현언어 EL(Expression Language)
	...
	3. 같은 이름이 다른 scope에도 존재하는 경우 우선 순위에 의해 처리됨
		pageContext > request > session > application
		(단 scope 지정 없으면 page -> application 순차검색)
--%>
	...
	<div>
		<ul>
			...
			<li>15 - 7 = ${15 - 7 }</li>
			<li>15 * 7 = ${15 * 7 }</li>
			<li>15 / 7 = ${15 / 7 }</li><!-- 소수점 이하 표시(double) -->
			<li>15 % 7 = ${15 % 7 }</li>
		</ul>
	</div>
	<hr>
