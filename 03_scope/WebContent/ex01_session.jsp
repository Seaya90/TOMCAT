...
<%
	String name = null;
	String age = null;
	System.out.println("attr_name: " + session.getAttribute("attr_name"));
	System.out.println("attr_age: " + session.getAttribute("attr_age"));
...
%>
	...
	<h2>세션유지시간 확인(기본 30분): <%=session.getMaxInactiveInterval() %></h2>		
</body>
</html>
